...
parent guides here, and a parallel graph looked at the non-parent (including
off-strand) guides.  [In both cases we excluded guides for non-essentials.]
'''
...
# FILTER: drop non-essential, off-strand, mismatch
