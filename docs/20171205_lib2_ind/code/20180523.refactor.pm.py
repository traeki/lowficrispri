...
def train_model(X_train, y_train, grouplabels):
...
def plot_predictions(y_test, preds, train_str, test_str, plotfile):
...
def train_eval_visualize(X_all, y_all, grouplabels, feat_cols):
  ...
  model = train_model(X_train, y_train, feat_cols)
  ...
  plot_predictions(y_test, preds, train_eval_str, test_eval_str, plotfile)
...
# TODO(jsh): add TensorFlow handles/vis
# TODO(jsh): color datapoints with seed mutations
# TODO(jsh): Try alternate models
