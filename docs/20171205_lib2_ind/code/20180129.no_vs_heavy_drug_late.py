...
QUESTION = '''
And this time the late doublings, just for completeness.
'''
...
sizes=10
ax = sns.regplot('a2d3_a3d3', 'b2d3_b3d3', data=filteredgammas, fit_reg=False,
...
plt.title('Growth from 7.5 - 10 doublings; No Drug vs. Heavy Drug')
plt.tight_layout()
