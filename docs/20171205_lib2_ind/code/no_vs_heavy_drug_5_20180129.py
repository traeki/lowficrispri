...
QUESTION = '''
How did phenotypes differ between drugged and undrugged samples over the
first 5 doublings (T0 -> T1)?
'''
...
sizes=10
ax = sns.regplot('t0d3_a1d3', 't0d3_b1d3', data=filteredgammas, fit_reg=False,
...
plt.title('Growth over 5 doublings; No Drug vs. Heavy Drug')
plt.tight_layout()
