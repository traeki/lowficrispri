...
samples over the late span (T2 -> T3)?
'''
...
replicate_pairs = [('a2d3_a3d3', 'b2d3_b3d3'),
                   ('a2d3_a3d3', 'c2d3_c3d3'),
                   ('b2d3_b3d3', 'c2d3_c3d3')]
labels = dict()
labels['a2d3_a3d3'] = 'No Drug - A'
labels['b2d3_b3d3'] = '30 ng/mL - B'
labels['c2d3_c3d3'] = '30 ng/mL - C'
...
fig.suptitle('Growth from 7.5 to 10 doublings')
