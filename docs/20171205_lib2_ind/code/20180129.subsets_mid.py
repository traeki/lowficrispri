...
samples over the middle span (T1 -> T2)?
'''
...
replicate_pairs = [('a1d3_a2d3', 'b1d3_b2d3'),
                   ('a1d3_a2d3', 'c1d3_c2d3'),
                   ('b1d3_b2d3', 'c1d3_c2d3')]
labels = dict()
labels['a1d3_a2d3'] = 'No Drug - A'
labels['b1d3_b2d3'] = '30 ng/mL - B'
labels['c1d3_c2d3'] = '30 ng/mL - C'
...
fig.suptitle('Growth from 5 to 7.5 doublings')
