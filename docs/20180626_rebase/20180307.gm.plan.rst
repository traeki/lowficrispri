...
* Basic reminder of why variable-efficacy CRISPRi
* Description of experimental layout
...
**************************
Show unadorned beak-graphs
**************************

* Overall signal looks good
* "Beak" artifact is recurring
* Clearly not an isolated screwup

Specific next objectives
++++++++++++++++++++++++

Distinguish Biology from Bias/Noise
-----------------------------------
* Can we get rid of the beak?
* Can we smooth out the noise for high gammas?
* What *is* the beak?

Design Next Library
-------------------
* What is the right measure of gamma for choosing the most useful guides
* Can we predict that value from other features (e.g. sequence, location, ...)

Explain the approach
++++++++++++++++++++

* Singular Value Decomposition (~PCA)
  * Find most variance-explaining basis vectors in measurement-space
  * Smooth away remaining variation as noise/bias

****************************
Show round-trip PC1-5 graphs
****************************

Beak-hunting
------------

* The beak is captured in a specific principal component
* Invert matrix to look at principal components in **strain-space**
* Identify outliers in each principle component
  * Most informative strains
* "Paint" outliers and see if beak pops out

********************************
Show refined beak-painting graph
********************************
